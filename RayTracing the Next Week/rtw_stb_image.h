...
#include "C:\Users\QinZefan\Desktop\代码\RayTracing in Next Week\RayTracing in Next Week\stb_image.h"
...
public:
    ...
    rtw_image(const char* image_filename) {
        ...
        size_t imagedirSize = 0;
        _dupenv_s(&imagedir, &imagedirSize, "earthmap.jpg");
